...
# ClosingTmuxWindowKillsTmuxWindows=0 설정 필수 (창 닫아도 세션 유지)
...
# 스테일 tmux 창 전체 정리
# ClosingTmuxWindowKillsTmuxWindows=0 설정으로 닫아도 세션 유지됨
# 컨트롤 창 닫으면 pseudo-tab 창도 자동 정리됨
...
log "스테일 tmux 창 ${_CLOSED_COUNT:-0}개 정리"
sleep 1
